  ...
  public static void main(String[] args) {
    ...
    */
    ...
    if (args.length == 1 && args[0].equals("-gui")) {
      ...
      try {
        ModelSpreadsheet worksheet = new ModelSpreadsheet();
        AdapterModel pro = new AdapterModel(worksheet);
        EditorView ed = new EditorView(pro);
        edu.cs3500.spreadsheets.provider.Controller ct =
                new edu.cs3500.spreadsheets.provider.Controller(pro, ed);
        ct.start();
      } catch (Exception e) {
        System.out.print(e);
      }
